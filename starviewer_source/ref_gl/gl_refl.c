...
void R_init_refl (int maxNoReflections)
{
	...
	qgl.FramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, g_refl_images[0]->texnum, 0);
...
#ifdef USE_FBO
		qgl.BindFramebufferEXT(GL_FRAMEBUFFER_EXT, g_refl_framebuffer); // todo - array of framebuffers
#endif
