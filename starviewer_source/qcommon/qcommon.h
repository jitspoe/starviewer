...
#define BUILD_S "0"
#else
#define	VERSION		1.0 // jitversion (was 3.21)
#define BUILD		1 // jitversion / jitbuild -- Paintball2 build number
#define BUILD_S		"1" // jitversion, for strings.
#define BUILD_YEAR	2013 // jitversion
#define BUILD_MONTH	12 // jitversion
#define BUILD_DAY	24 // jitversion
#define	BASEDIRNAME	"starviewer" // jit, was "baseq2"
#endif
